<?php
// Admin bin_item_common detail view for weapons
...
// Get bin data
$binData = $weaponModel->getBinItemData($nameId);
...
// Get all weapon items related to this bin data
$relatedWeapons = $weaponModel->getWeaponsByNameId($nameId);
...
<main>
    <section class="section">
        <div class="container">
                ...
                <div class="admin-detail-section">
                    ...
                    <div class="admin-detail-row">
                        ...
                        <div class="admin-detail-value">
                            ...
                            <img src="<?php echo $weaponModel->getWeaponIconUrl($binData['icon_id']); ?>" alt="Icon" class="admin-detail-icon">
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <!-- Related Weapon Items -->
            <?php if (!empty($relatedWeapons)): ?>
            <div class="admin-related-section">
                <h2 class="admin-section-title">Related Weapon Items</h2>
                ...
                <div class="admin-table-container">
                    <table class="admin-table">
                        ...
                        <tbody>
                            <?php foreach ($relatedWeapons as $weapon): ?>
                            <tr>
                                <td><?php echo $weapon['item_id']; ?></td>
                                <td>
                                    <img src="<?php echo $weaponModel->getWeaponIconUrl($weapon['iconId']); ?>" alt="<?php echo htmlspecialchars($weapon['desc_en']); ?>" class="admin-table-icon">
                                </td>
