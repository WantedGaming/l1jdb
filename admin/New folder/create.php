...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Create armor
    $newArmorId = $armorModel->createArmor($armorData);
    if ($newArmorId) {
        ...
        $user->logActivity(
            ...
            'create',
            "Added new armor: {$armorData['desc_en']} (ID: $newArmorId)",
            'armor',
            $newArmorId
        );
        
        // Redirect to detail page with success message
        header('Location: ../../public/armor/detail.php?id=' . $newArmorId . '&created=1');
        exit;
    } else {
        $errorMessage = "Failed to create armor. Please try again.";
    }
}
            ...
            <div class="admin-form-container">
                <form action="create.php" method="post" class="admin-form">
                    ...
                    <div class="admin-detail-layout">
                        ...
                        <div class="admin-image-card">
                            ...
                            <div class="admin-image-container">
                                <img id="armorPreview" src="/assets/images/icons/placeholder.png" alt="Armor Preview" class="admin-image-large">
                            ...
                            <div class="admin-basic-form">
                                ...
                                <div class="admin-form-row">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="number" id="Set_Id" name="Set_Id" class="admin-form-input" value="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-row">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="number" id="ac" name="ac" class="admin-form-input" value="0" required>
                                    </div>
                                    
                                    <div class="admin-form-group">
                                        <label for="ac_sub" class="admin-form-label">AC Sub</label>
                                        <input type="number" id="ac_sub" name="ac_sub" class="admin-form-input" value="0">
                                    </div>
                                </div>
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-row">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="number" id="defense_water" name="defense_water" class="admin-form-input" value="0">
                                    </div>
                                    
                                    <div class="admin-form-group">
                                        <label for="defense_wind" class="admin-form-label">Wind Defense</label>
                                        <input type="number" id="defense_wind" name="defense_wind" class="admin-form-input" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="admin-form-row">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="number" id="defense_fire" name="defense_fire" class="admin-form-input" value="0">
                                    </div>
                                    
                                    <div class="admin-form-group">
                                        <label for="defense_earth" class="admin-form-label">Earth Defense</label>
                                        <input type="number" id="defense_earth" name="defense_earth" class="admin-form-input" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="admin-form-row">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="number" id="attr_all" name="attr_all" class="admin-form-input" value="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-row">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="number" id="regist_stone" name="regist_stone" class="admin-form-input" value="0">
                                    </div>
                                    
                                    <div class="admin-form-group">
                                        <label for="regist_sleep" class="admin-form-label">Sleep Resistance (%)</label>
                                        <input type="number" id="regist_sleep" name="regist_sleep" class="admin-form-input" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="admin-form-row">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="number" id="regist_freeze" name="regist_freeze" class="admin-form-input" value="0">
                                    </div>
                                    
                                    <div class="admin-form-group">
                                        <label for="regist_blind" class="admin-form-label">Blind Resistance (%)</label>
                                        <input type="number" id="regist_blind" name="regist_blind" class="admin-form-input" value="0">
                                    </div>
                                </div>
                        ...
                        <div class="admin-tab-pane" id="description-tab">
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-group">
                                    ...
                                    <textarea id="note" name="note" class="admin-form-textarea" rows="8"></textarea>
                                </div>
                    ...
                    <div class="admin-form-buttons">
                        ...
                        <button type="submit" class="admin-button admin-button-primary">Create Armor</button>
                    </div>
                </form>
            </div>
        </div>
