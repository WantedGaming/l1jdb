                    ...
                    <div class="filter-group">
                        ...
                        <select id="material" name="material" class="filter-select">
                            ...
                            <option value="<?php echo $material; ?>" <?php echo (isset($filters['material']) && $filters['material'] === $material) ? 'selected' : ''; ?>>
                                <?php echo formatArmorMaterial($material); ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <div class="card item-card">
                        ...
                        <div class="card-header">
                            ...
                            <span class="card-badge"><?php echo formatGrade($armor['itemGrade']); ?></span>
                        </div>
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-stats">
                                ...
                                <div class="card-stat">
                                    ...
                                    <span class="card-stat-value"><?php echo formatArmorMaterial($armor['material']); ?></span>
                                </div>
